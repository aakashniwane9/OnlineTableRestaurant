...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder>{
    ...
    public CartAdapter(List<CartList> listItems, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        CartList cartList = listItems.get(position);
        viewHolder.name.setText(cartList.getName());
        viewHolder.cost.setText(cartList.getCost());
        viewHolder.status.setText(cartList.getStatus());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView name,cost,status,quantity;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            cost = (TextView) itemView.findViewById(R.id.cart_item_cost);
            status = (TextView) itemView.findViewById(R.id.cart_item_status);
