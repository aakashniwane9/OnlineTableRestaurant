 ...
 * {@link FragmentVeg.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentVeg#newInstance} factory method to
...
public class FragmentVeg extends Fragment {
     ...
     * @return A new instance of fragment FragmentVeg.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentVeg newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.fragment_veg_recyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        listItems=new ArrayList<>();


        myRef.child("menu").child("Veg").addValueEventListener(new ValueEventListener() {
            @Override
